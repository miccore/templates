...
namespace  Miccore.Net.webapi_template.User.Api.Services.User {
    ...
    public class UserService : IUserService {
        ...
        public async Task<UserDomainModel> UpdateRefreshTokenAsync(UserDomainModel User)
        {
            var dto = await _userRepository.UpdateRefreshTokenAsync(_mapper.Map<UserDtoModel>(User));
            return _mapper.Map<UserDomainModel>(dto);
        }
